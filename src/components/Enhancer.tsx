...
import { removeBackgroundLocal, type FreeBackground } from "@/lib/bg";
...
export default function Enhancer() {
  ...
  // background/enhance settings. Shared by auto-removal and the Edit editor. With the
  // enhance toggles off it just composites onto the background (plain removal).
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-4 rounded-lg border border-neutral-800 p-4">
        ...
        <div className="space-y-2">
          <div className="text-xs font-semibold uppercase tracking-wide text-neutral-500">Finish (optional)</div>
        ...
        <p className="text-xs text-neutral-600">
          Removes the background locally — free, no credits, nothing uploaded. Turn on the finishing options above to
          auto-correct color &amp; lighting, add a contact shadow, or square the framing. The first photo downloads a
          small one-time model.
        </p>
      </div>
